...
// 大小: 99026 bytes ( 10 source files)
...
// ===== t1Presets.js =====
// Auto-generated T1 presets — 数组格式，每条为完整口播句
// Updated: 2026-07-16 · 12组 × 3条
// 匹配逻辑：选题文字→精确匹配→模糊匹配→自动兜底
window.___t1Presets = {
  // 1. 宽带选题
  "宽带选多少兆": [
...
// Updated: 2026-07-16 · 每条为完整口播句
window.___t4Presets = {
  '免费贴膜': {
    benefit: '免费贴膜', desc: '进店免费贴膜，苹果安卓曲面直屏都能贴，比外面30块的还好。不用预约来了就贴。',
    tags: '#免费贴膜 #手机贴膜 #同城福利'
  },
  '免费测速': {
    benefit: '免费WiFi测速', desc: '到店或者预约上门，免费测你家宽带到底跑多少兆。不满速当场排查，看看是套餐问题还是路由器问题。',
    tags: '#免费测速 #宽带测速 #WiFi优化'
  },
  '办业务送礼': {
    benefit: '办业务送好礼', desc: '新装宽带送千兆路由器，续约升档送流量包，老用户积分还能兑换精美礼品。办了不亏。',
    tags: '#办业务送礼 #宽带优惠 #新装好礼'
  },
  '以旧换新': {
    benefit: '以旧换新最高抵1000', desc: '旧手机旧光猫旧路由器拿来抵钱，换新款合约机最高能抵1000元。旧设备扔了也是扔了不如拿来换钱。',
    tags: '#以旧换新 #合约机 #换新机'
  },
  '手机清洁': {
    benefit: '免费手机清洁', desc: '进店免费给手机做超声波清洁加屏幕消毒还有系统缓存清理。几十块钱的清洁钱省了手机还跟新的一样。',
    tags: '#手机清洁 #免费服务 #手机保养'
  },
  '宽带体验': {
    benefit: '千兆宽带免费体验', desc: '到店体验千兆宽带到底有多快。下载一部4K电影只要10秒刷视频一点不卡，跟家里百兆宽带对比一下就知道差距。',
    tags: '#千兆宽带 #免费体验 #网速对比'
  },
  '暑期纳凉': {
    benefit: '进店纳凉送冰水', desc: '天热没处去？进来吹空调喝冰水免费贴膜免费测速。不办业务也没关系路过进来凉快一下。',
    tags: '#暑期纳凉 #营业厅空调 #免费贴膜 #同城福利'
  },
  '学生购机': {
    benefit: '学生购机暑期专享', desc: '凭学生证准考证录取通知书享专属优惠价，购机还送大礼包。高考完准备换手机的趁暑假过来挑最划算。',
    tags: '#学生购机 #暑期特惠 #开学准备 #准大学生'
  },
  '全家桶特惠': {
    benefit: '暑假全家宽带手机一站式', desc: '宽带加手机加IPTV一起办，比单独办省一半。适合一家三口暑期使用，爸妈的手机孩子的宽带一次搞定。',
    tags: '#全家桶 #宽带优惠 #暑假 #一站式'
  },
  '社区服务': {
    benefit: '电信进社区便民服务', desc: '宽带义诊加手机贴膜加业务咨询，不出小区就能办。老人行动不便的提前说一声我们上门服务。',
    tags: '#社区服务 #便民 #上门服务'
  }
};
