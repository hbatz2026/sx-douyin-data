// 抖本工坊 · 数据包（自动合并 17 文件）
// 生成时间: 2026-07-20 06:09:10
// 合并文件: bgmList.js, dailyScripts.js, hotspotData.js, phonePool.js, publish-kit.js, t1Comments.js, t1ImagePrompts.js, t1Presets.js, t1ScriptFull.js, t1ScriptStyles.js, t1Titles.js, t2Presets.js, t2ScriptFull.js, t4Presets.js, t4ScriptFull.js, techDB.js, topicPool.js
// 大小: 145304 bytes ( 17 source files)
...
// previewT1Talk 预览底部渲染，营业员复制到豆包/即梦生成视频封面
// 更新：2026-07-20
window.___t1ImagePrompts = {
  "宽带选多少兆": "一张抖音竖版9:16海报，深蓝渐变背景（#0A1628→#1A237E）。中央白色大字「宽带选多少兆？」副标题一行小字「看完不花冤枉钱」。底部浅灰字「截图保存 · 随时查看」。整体苹果发布会式简洁高级感，不堆砌元素。顶部小号字体「太原电信营业厅」。",
  "套餐怎么选": "竖版9:16抖音封面。深蓝紫色渐变背景。白色大字「套餐选错了？」，下面一行浅蓝字「每月多花几十块」。底部「截图保存」。页面干净，不拥挤，像手机官方海报质感。",
  "家庭宽带怎么选？三口之家最优方案": "9:16竖版海报。深蓝偏灰背景。白色大字「三口之家宽带」，大字下方浅色字「300兆就够了」。左下角小字「太原电信营业厅」。底部「💰 截图保存」。高级感，不促销感。",
  "携号转网全流程攻略": "竖版9:16。暗蓝紫色渐变底。白色大字「携号转网」，大字下方「算好三笔账再转」。底部一行小字「违约金·套餐·信号」。干净信息型海报风格。",
  "宽带到期续费还是换套餐？决策树帮你判断": "9:16竖版。蓝紫渐变。白色大字「宽带到期了？」，第二行小字「续费还是换？3个问题告诉你」。底部「截图保存，到期不慌」。",
  "家人合办副卡亲情号怎么划算": "竖版9:16。暖蓝色底。白色大字「一家人各交各的话费？」，副标题「每月多花好几十」。底部小字「融合套餐人均30封顶」。温暖家庭感色调。",
  "合约机 vs 买裸机，3年算下来谁省钱？": "9:16竖版。深蓝渐变。中央白色大字「合约机还是裸机？」，下面「3年省一台手机」。底部浅色字「截图保存，买机前看」。科技感。",
  "家里WiFi信号差？先别急着换路由器": "竖版。蓝绿色渐变底。白色大字「WiFi信号差？」，副标题「90%不是路由器的锅」。底部「截图保存。先排查再花钱」。清新技术风。",
  "家里网络老掉线先排查这3个原因": "9:16竖版。暗蓝底。白色大字「网断了先别报修」，副标题「自己3步搞定」。底部「重启→查灯→报修」。信息卡片风格，清晰可读。",
  "手机套餐隐藏权益大盘点": "竖版9:16。暖色橙蓝渐变。白色大字「你的话费里白给了？」，副标题「每月多交好几十」。底部「💰 截图去查」。简约不炫目。",
  "直播带货用什么网络最稳？选网避坑指南": "9:16竖版。深紫红渐变。白色大字「直播老卡顿？」，副标题「不是技术问题，是宽带没选对」。底部「做直播选千兆」。科技性能感。",
  "租房宽带怎么选？短期vs长期租房攻略": "竖版。清新蓝绿色底。白色大字「租房宽带怎么选？」，副标题「按租期选，不浪费」。底部「短期→流量卡 长期→融合套餐」。清新实用风。",
  "打游戏用什么宽带？延迟对比实测": "9:16竖版。暗蓝底+橙色点缀。白色大字「打游戏延迟460？」，副标题「不是技术问题，是宽带没选对」。底部「300兆起步，千兆电竞级」。游戏风格。",
  "FTTR到底值不值得装？用数据说话": "竖版。深蓝底+暖橙渐变。白色大字「FTTR值不值？」，副标题「看你家多大」。底部「90平以内→不用 120平以上→需要」。科技感对比风格。",
  "学生套餐怎么选？4款热门横向对比": "9:16竖版。活力渐变（蓝→紫）。白色大字「学生套餐怎么选？」，副标题「29块够用99块封顶」。底部「🎓 带学生证来办」。年轻活力风。",
  "老人手机套餐怎么选？3款适老套餐对比": "竖版。暖杏色渐变底。白色大字「你爸妈的话费可能比你还贵」，副标题「换这个省一半」。底部「👴 帮爸妈省钱」。温暖亲切风，字大清晰。",
  "异地跨省宽带怎么装最省钱": "9:16竖版。蓝灰渐变。白色大字「老家一套房城里一套」，副标题「宽带怎么装最省？」。底部「融合套餐比单独办省一半」。简洁商务风。",
  "电视盒子卡顿IPTV和网络盒子怎么选": "竖版。深蓝底。白色大字「电视盒子老是卡？」，副标题「不是网速问题」。底部「IPTV 10元/月，不卡」。技术排障风。"
};
