...
// 大小: 340061 bytes ( 21 source files)

// ===== bgmList.js =====
// 抖本工坊 · BGM推荐（手动更新 2026-07-25）
// 源：抖音热门BGM + 网易云热歌榜 + 营业厅实地验证
window.___bgmList = {
  "决策指南": {
    "轻快对比": [
      "小城夏天 - LBI利比",
  ...
  "产品测评": {
    "科技感": [
      "星际穿越 - Hans Zimmer（纯音乐）",
      "Time Back - 抖音版",
      "One Spot - 沈佳润Nina"
    ],
    "速度节奏": [
      "Sold Out - Hawk Nelson（纯音乐）",
      "Believer - Imagine Dragons（轻版）",
      "Natural - Imagine Dragons（伴奏）"
    ],
    "轻松教学": [
      "Windy Hill - 羽肿",
      "River Flows In You - Yiruma",
  ...
  "本地活动": {
    ...
    "紧迫倒计时": [
      ...
      "Counting Stars - OneRepublic（快节奏版）",
...
window.___hotspotData = [
  {
    ...
    "steps": [
      ...
      {"shot": "用手机展示家庭WiFi/宽带的重要性，台风天更需要稳定网络", "sub": "过渡到FTTR/千兆宽带推荐"},
      {"shot": "结束CTA：地址+到店福利", "sub": "字幕：📍山西电信营业厅 风雨无阻为您服务"}
    ],
    "bgm": "Windy Hill - 羽肿（钢琴轻柔版）", "tags": "#台风红霞 #电信服务 #风雨无阻",
  ...
  },
  {
    ...
    "bgm": "悬疑电子音（音量20%）——改编用轻钢琴替代", "tags": "#数据安全 #防诈骗 #携程被罚",
  ...
  },
  {
    ...
    "bgm": "小城夏天 - LBI利比（轻快活泼）", "tags": "#真香 #全家套餐 #淄博博山菜",
  ...
  },
  {
    ...
    "steps": [
      ...
      {"shot": "展示测速过程：卡顿→诊断→修复→满速", "sub": "路由器位置/老旧是关键"},
      {"shot": "对比前后网速数字（100M→300M实测）", "sub": "字幕：免费测速到店"},
      {"shot": "结束CTA：来店免费测，卡了别忍", "sub": "字幕：📍山西电信 免费WiFi体检"}
    ],
    "bgm": "卡点电子节奏（音量25%）", "tags": "#WiFi卡顿 #免费测速 #故障画风",
  ...
  },
  {
    ...
    "bgm": "阳光开朗大男孩 - 卦者灵风（青春活力）", "tags": "#暑期流量 #学生套餐 #暑假自由",
  ...
  },
  {
    ...
    "bgm": "激昂电子/管弦乐（国风科技感）", "tags": "#盾构机 #中国速度 #千兆宽带 #5G",
    "difficulty": 2, "needFace": true, "time": "8分钟"
  }
];
