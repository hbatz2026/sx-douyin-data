...
// 大小: 380332 bytes ( 21 source files)
        ...
        "warm": {
          ...
          "storyboard": [
            ...
            },
            {
              "sec": "3-13",
              "speaker": "掰手指对比",
              "text": "100M=1-2人 | 300M=3-5人 | 1000M=全屋智能",
              "camera": "手写板/白板画示意图"
            },
            {
              "sec": "13-20",
        ...
        "tech": {
          ...
          "storyboard": [
            ...
            },
            {
              "sec": "3-13",
              "speaker": "数据对比图表",
              "text": "100M:12.5MB/s 300M:37.5MB/s 1000M:125MB/s",
              "camera": "平板上显示对比图"
            },
            {
              "sec": "13-20",
        ...
        "tech": {
          ...
          "storyboard": [
            ...
            },
            {
              "sec": "3-13",
              "speaker": "对比分析",
              "text": "100M→30秒 300M→10秒 1000M→3秒",
              "camera": "技术对比画面"
            },
            {
              "sec": "13-20",
          ...
          "storyboard": [
            {
              "sec": "0-3",
              "speaker": "干练外套",
              "text": "看电影=200块 在家看=免费",
              "camera": "办公室口播"
            },
            {
              "sec": "3-13",
              "speaker": "列数据",
              "text": "电影院vs家庭影院 年省3000元",
              "camera": "数据对比"
            },
            {
              "sec": "13-20",
              "speaker": "自家案例",
              "text": "300M宽带=3年省出一台电视",
              "camera": "算账展示"
            },
            {
              "sec": "20-25",
...
window.___t1Presets = {
  ...
  "FTTR到底值不值得装": {
    "不装(单路由)": "90平以内单千兆路由够用。¥200-500一次性。适合小户型。",
    "装基础FTTR": "120平以上大平层。月费¥59起，全屋光纤每间房满格。推荐。",
    "装全套FTTR": "复式/别墅。月费¥99起，每层独立光纤，全家无缝漫游。一步到位。"
  },
  "家里WiFi信号差怎么办": {
    "免费调位置": "路由器放客厅中间高处。到店免费帮你调。0成本提升50%速度。",
    "换WiFi6路由": "旧路由5年以上→换千兆WiFi6。¥200-500，网速翻倍。推荐。",
    "升级FTTR": "大户型/复式→FTTR光纤到每间房。¥59/月起，全屋满格。"
  },
  "打游戏选什么宽带": {
    "100M": "延迟50-80ms，回合制/策略类够用。大型FPS会卡。月费¥59。",
    "300M(推荐)": "延迟30-50ms，MOBA/FPS都稳。月费¥99。性价比高。",
    "千兆": "延迟10-20ms，职业级体验。直播推流零压力。月费¥169。"
  },
  "老人用什么套餐": {
    "孝心卡19元": "2G流量+100分钟+防诈骗提醒。¥19/月，够轻度使用。",
    "孝心卡39元": "10G流量+300分钟+健康服务。¥39/月，刷抖音够用。推荐。",
    "孝心卡59元": "25G流量+500分钟+送视频会员。¥59/月，重度使用。"
  },
  "学生套餐怎么选": {
    "校园29元": "20G校园流量+免费WiFi。¥29/月，适合低消费。",
    "校园49元": "30G流量+300分钟通话。¥49/月，性价比之选。推荐。",
    "校园99元": "100G+1000分钟+校园宽带。¥99/月，全能型。"
  },
  "流量不够用怎么加": {
    "套餐升档": "月费¥10-20升级，流量翻倍。最划算的方案。",
    "办副卡": "¥10/月，20G独立流量。适合双卡用户。",
    "融合套餐共享": "全家共享100G+，人均¥30-50。全家用最划算。推荐。"
  },
  "全屋WiFi怎么布局": {
    "90平(单路由)": "一个千兆路由放客厅中间。¥200-400。小户型够用。",
    "120平(Mesh)": "2-3节点Mesh组网。¥400-800，全屋无死角。推荐。",
    "复式/别墅(FTTR)": "光纤到每个房间。¥59-99/月，一步到位。"
  },
  "家里网络老掉线": {
    "检查位置": "路由器旁有微波炉/冰箱？挪开30cm。0成本。",
    "检查散热": "路由器塞柜子里？拿出来通风。0成本。",
    "到店报修": "以上都试了还掉线？到店免费检测线路。免费。"
  },
  "5G套餐到底快多少": {
    "4G套餐": "下行50-80Mbps。刷抖音微信够用。月费¥59。",
    "5G入门(推荐)": "下行300-500Mbps。看4K视频流畅。月费¥79。推荐。",
    "5G极速": "下行800Mbps+。下载大文件秒完。月费¥129。"
  },
  "老房子没预埋网线": {
    "电力猫": "利用电线传输，不布线。适合小户型，¥100-300。",
    "Mesh无线组网": "无线回程，不用打孔。90-140平，¥300-800。",
    "FTTR隐形光纤": "透明光纤沿踢脚线走。千兆满速。¥59/月起。推荐。"
  },
  "租房宽带怎么选": {
    "短租(<6月)": "灵活合约，2个月起租。到期自动停不用退。¥59/月起。",
    "长租(>1年)": "融合套餐¥99/月。宽带+手机卡+路由器。划算。推荐。",
    "长租+全家": "全家融合套餐¥169/月。千兆+3张卡。一步到位。"
  },
  "携号转网怎么办理": {
    "查资格": "编辑短信到运营商查能否转。免费，2分钟出结果。",
    "拿授权码": "符合条件去营业厅拿授权码。免费，半小时办好。",
    "来厅选套餐": "带身份证+授权码到电信厅选套餐，当场生效。推荐。"
  },
  "宽带到期续费还是换": {
    "原地续费": "原套餐不变继续用。适合对现有套餐满意的老用户。",
    "换新套餐": "同价位流量翻倍。3年以上的套餐建议换新。推荐。",
    "升级融合": "全家共享流量+宽带。人均更便宜。一步到位。"
  },
  "多人合租网络怎么分": {
    "各办各的": "各自办套餐。月费¥59/人起，自由但贵。",
    "合办一条": "合办300兆均摊。人均¥33/月。省钱但需管理账单。",
    "融合套餐(推荐)": "三人融合¥169/月。千兆+3张卡，人均¥56。省心。"
  },
  "家里有学生上网课": {
    "100M": "1个孩子+轻度上网。月费¥59。一孩家庭。",
    "300M(推荐)": "2-3个孩子+家长使用。含网课加速。月费¥99。推荐。",
    "千兆": "多孩+智能家居。月费¥169。全场景无瓶颈。"
  },
  "一个人住选什么宽带": {
    "100M(推荐)": "刷视频聊天够用。月费¥59。一个人住正合适。推荐。",
    "300M": "打网游看4K不卡。月费¥99。适合重度用户。",
    "1000M": "月费¥169。一个人用太浪费，不推荐。"
  },
  "三口之家选什么宽带": {
    "100M": "偶尔上网轻量使用。月费¥59，可能紧张。",
    "300M(推荐)": "全家同时在线不卡+网课加速。月费¥99。推荐。",
    "千兆": "4K+游戏+办公互不干扰。月费¥169。一步到位。"
  },
  "监控摄像头用4G还是宽带": {
    "4G摄像头": "无宽带可用处。插卡即用，月流量费¥10-20。",
    "WiFi摄像头(推荐)": "有宽带处用。零额外月费，画质稳定。推荐。",
    "两种都装": "老家+城里各一台。走各自的网。"
  },
  "直播带货用什么宽带": {
    "100M": "上行仅20M，推流就满。不推荐。",
    "300M(推荐)": "上行50M，推流+互动+音效不卡。¥99/月。推荐。",
    "千兆": "上行200M+FTTR。多人同时播。¥169/月。专业级。"
  },
  "智能家居需要多大带宽": {
    "50个设备内": "100M轻松带。智能设备不走主力频段。无需升级。",
    "80个设备内": "300M还有余量。不影响正常用网。",
    "80+带监控": "可上千兆。全屋4K监控无压力。"
  },
  "电视盒子卡顿怎么办": {
    "连WiFi的盒子": "多人抢网卡→升300M。¥99/月能搞定。",
    "IPTV专线盒子": "机顶盒问题→到厅换新。免费检测。",
    "路由器老旧": "5年以上路由→换WiFi6千兆。¥200起。"
  },
  "电信联通移动怎么选": {
    "电信(推荐)": "稳定98.5%，延迟18ms，售后4小时。打游戏首选。推荐。",
    "联通": "稳定95%，延迟25ms，售后8小时。性价比。",
    "移动": "稳定91%，延迟35ms，高峰期掉速。便宜但体验一般。"
  }
};
