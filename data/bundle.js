...
// 大小: 348938 bytes ( 21 source files)
...
window.___t1Presets = {
  ...
  "学生套餐怎么选": {
    ...
    "校园49元": "30G流量+300分钟通话。¥49/月，性价比之选。",
    "校园99元": "100G+1000分钟+校园宽带。¥99/月，全能型。推荐。"
  },
  "流量不够用怎么加": {
  ...
  "全屋WiFi怎么布局": {
    ...
    "120平(Mesh)": "2-3节点Mesh组网。¥400-800，全屋无死角。",
    "复式/别墅(FTTR)": "光纤到每个房间。¥59-99/月，一步到位。推荐。"
  },
  "家里网络老掉线": {
  ...
  "租房宽带怎么选": {
    "短租(<6月)": "短期宽带¥59/月。灵活合约，随时可退。",
    "长租(>1年)": "融合套餐¥99/月。宽带+手机卡+路由器。划算。",
    "长租+全家": "全家融合套餐¥169/月。千兆+3张卡。一步到位。推荐。"
  },
  "携号转网怎么办理": {
  ...
  "多人合租网络怎么分": {
    ...
    "合办一条": "合办300兆均摊。人均¥33/月。省钱但需一人管理账。",
  ...
  "监控摄像头用4G还是宽带": {
    "4G摄像头": "无宽带可用处。插卡即用，月费¥10-20。",
    "WiFi摄像头(推荐)": "有宽带处用。零月费，画质稳定。推荐。",
    "两种都装": "老家+城里各一台。走各自的网。"
  },
  "直播带货用什么宽带": {
