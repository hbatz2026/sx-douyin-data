...
window.___t1ScriptFullByPersona = {
  ...
  "购机 vs 买裸机，3年算下来谁省钱？": {
    "sister": "上个月一个小伙子算了一下午购机划算还是裸机划算。那台手机裸机2999。购机首付999月费含话费流量，三年共2880。比裸机省了119还送充电宝和耳机。有旧手机以旧换新折价加补贴最高抵1000——相当于半价换新。\n\n你遇到过这种情况吗？评论区举个手我看看。\n位置：南中环电信营业厅。来店里报我名字，免费帮你查。",
...
// ===== topicPool.js =====
// 抖本工坊 · 选题池 v2.8 （搜索截流引擎 · 手动校准版）
// 2026-07-25 更新  |  每周一自动刷新
// 每类：4条电信原生 + 3条截流（移动/联通搜索词 → 改写为电信视角）
window.___topicPool = {
  "decision": [
    "电信宽带套餐价格表2026（各个档位怎么选）",
    "电信套餐2026新套餐一览 哪个最划算",
    "FTTR和普通千兆宽带区别 到底值不值得多花钱",
    "电信宽带套餐怎么改便宜的套餐",
    "移动宽带套餐最低多少钱 → 对比电信能省多少",
    "联通宽带资费一览 → 携号转网到电信每月少花多少",
    "宽带选电信还是移动 老用户实测对比"
  ],
  "scene": [
    "电信宽带报修多久上门 真实经历分享",
    ...
    "电信营业厅周六周日上班吗 几点到几点",
    "移动宽带报修 → 干脆携转到电信一次解决",
    "联通宽带故障怎么办 试过这三步如果还不行就来电信",
    "信号差？换运营商前先试试这个方法 电信免费帮你查"
  ],
  "review": [
    "电信宽带测速在线实测 不同套餐差距有多大",
    "WiFi满格但网络很差怎么办 三步排查法",
    "千兆宽带下载速度多少正常 电信 vs 普通宽带实测",
    "路由器推荐：什么牌子的信号最好 营业厅实测三款",
    "FTTR到底值不值 移动/联通用户过来看电信千兆体验",
    "5G手机为什么显示4G信号 电信5G覆盖实测",
    "携号转网后网速变快了吗 移动转电信用户三个月后的真实反馈"
  ],
  "local": [
    "以旧换新手机怎么换 电信营业厅全流程",
    "免费贴膜活动 苹果安卓都能贴 到店就免费",
    "积分兑换好礼 你攒的积分别浪费",
    "老客户专属福利 在网3年以上到店免费升级流量",
    "移动携转到电信怎么办理 不换号半个小时搞定",
    "联通宽带到期想换电信 注销加新装一条龙",
    "宽带套餐到期不想用了怎么办 携转到电信无缝切换"
  ]
};
