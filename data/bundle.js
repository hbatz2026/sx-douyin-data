...
// 大小: 340446 bytes ( 21 source files)
...
window.___t1Presets = {
  ...
  "合约机还是裸机": {"合约机(月付)":"首付低月租含话费+流量+宽带。3年比裸机少500-1500元。","裸机(全款)":"一次付清自由换套餐。适合已有满意套餐不想被绑定的。","以旧换新":"旧手机折价+电信补贴=新机半价。有旧机想升级的最划算。"},
...
window.___t1ScriptFullByPersona = {
  ...
  "宽带到期续费还是换套餐？决策树帮你判断": {
    ...
    "biz": "结论：宽带到期不续费，先查最新套餐再决定。\n\n决策树：1. 查看当前套餐与最新版对比→如果有升值换新套餐；2. 查看近半年月均用量变化→如果增长超50%升级融合套餐；3. 当前套餐唯一最适合→续费保留。\n\n建议截图到店免费出分析报告，5分钟搞定。\n\n点关注，这个系列会把家庭通信怎么省钱讲透。\n你现在的套餐月租多少？评论告诉我，帮你算算有没有更优解。",
...
window.___t4ScriptFullByPersona = {
  ...
  "免费WiFi体检": {
    ...
    "young": "今天免费帮你测WiFi你家网速到底有多少是路由器在给你拖后腿。上次帮一个客户测他家客厅满格卧室一格—路由器塞柜子里了搬出来立马全屋满格。一分钱不要你自己带路由器来我帮你测免费出结论。评论说你家多大我告诉你怎么摆最好。",
    "master": "今天免费WiFi体检你带路由器来我帮你看问题出在哪。上个月帮一户测客厅满格卧室连不上—路由器塞电视柜里墙壁全挡住了。拿出来放到客厅中间全屋满格。不要钱免费帮你看位置不对信号在损耗你的网费白交。",
    "sweet": "今天免费给你家WiFi做体检。上次一个客户家客厅满格卧室居然连不上路由器原来是塞在柜子里啦挪出来就好了全屋满格。你家的路由器也放柜子了吗？今天带来我免费帮你看信号最强的位置在哪不收钱。评论区发个户型面积我帮你看。"
  },
  "夜场闪购活动": {
