...
// ===== phonePool.js =====
// Auto-generated from terminal inventory screenshot (2026-07-05)
// Source: D:\工作日志\自营厅运营\...\终端机型\7月5日机型.png
// Updated: 2026-07-06
// Total: 18 models (10 core)
// NOTE: 完整自动化脚本已就绪: scripts/update-phone-pool.mjs
//       配置 SILICONFLOW_API_KEY 后可全自动 OCR + 推送
window.___phonePool = [
  // ═══ 荣耀 HONOR ═══
...
window.___t2Presets = {
  ...
  '高考换机': { time: '高考结束第二天', customer: '准大学生和家长', problem: '考完第二天家长就带孩子来挑手机了，预算有限但要求不低：又要打游戏又要学习用还要好看', finding: '很多家长对合约机和裸机搞不清楚，以为交话费领手机就是免费的', steps: '1. 先问孩子用机习惯（打游戏多还是学习多）\n2. 讲清楚合约机和裸机的区别\n3. 推荐合适机型并当场开箱激活', reaction: '孩子拿到新手机开心得不行，家长说比网上买放心多了，有售后还能教怎么用', summary: '高考后的第一台手机，值得家长带孩子来实体店买', tags: '#高考换机 #准大学生 #第一台手机 #合约机科普' },
  '暑期换机': { time: '七月中旬', customer: '暑期打工的学生', problem: '用暑假打工攒的钱来买手机，预算很有限但想做分期', finding: '学生没信用卡做不了分期，但暑期有学生专属优惠和赠品方案', steps: '1. 了解学生预算和心仪机型\n2. 推荐同价位性价比最高的选择\n3. 办理学生专属套餐+赠品（耳机/充电宝/保护壳）', reaction: '拿着新手机和赠品走的，说暑假打工值了', summary: '暑假不只有打工，还有攒钱买新手机的那份成就感', tags: '#暑期换机 #学生购机 #打工换新机 #性价比' }
};
// ===== t4Presets.js =====
...
window.___topicPool = {
  "decision": [
    ...
    "电信&联通&移动宽带怎么选？全方位横评",
    "家里有学生上网课，宽带怎么选？",
    "高考结束换手机，千元机/中端机/旗舰机怎么选？",
    "毕业入职第一份工资买手机，3000预算最值得推荐",
    "孩子考上大学了，该配什么手机和套餐？",
    "618没赶上？暑期换机季同样有好价"
  ],
  "scene": [
    ...
    "高考完第一天，店里挤满了来挑手机的准大学生和家长",
    "毕业季帮学长打包行李，顺便推荐了新城市新号码",
    "妈妈来给孩子办学生套餐，掏出高考准考证那一刻笑了",
    "暑期实习第一天，大三学生来办人生第一张自己名下的卡"
  ],
  "review": [
    ...
    "旧路由器别扔！3种方法让它变废为宝",
    "准大学生手机选购指南：不打游戏≠不用好手机",
    "毕业入职通信套餐怎么选？职场新人省钱攻略",
    "暑期出游流量不够用？临时加量方案实测"
  ],
  "local": [
    "暑假福利！学生宽带半价，家长速来",
    ...
    "新用户首月免费体验千兆宽带",
    "积分兑换活动开启，您的积分可以换好礼",
    "高考生专属福利：准考证到店办理任选一项优惠",
    "毕业季校园卡直通车：5G套餐+大流量，新生老生都能办",
    "暑期全家桶优惠：宽带+电视+手机一站式搞定",
    "本周末营业厅暑期大促，以旧换新最高抵2000"
  ]
};
