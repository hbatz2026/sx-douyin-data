...
// Updated: 2026-07-23 — 全量补完24+决策选题
window.___t1Presets = {
  "宽带选多少兆": {
  ...
  "FTTR到底值不值得装？用数据说话": {
    "不装(用单路由)": "90平以内单千兆路由够用。¥200-500一次性，适合小户型。",
    "装一套(FTTR基础)": "120平以上大平层。月费¥59起，全屋光纤覆盖，每间房满格。",
    "装全套(FTTR全覆盖)": "复式/别墅用FTTR全屋套餐。月费¥99起，每层独立光纤。"
  },
  "家里WiFi信号差？先别急着换路由器": {
    "免费调位置": "路由器放角落/弱电箱→信号差。搬到客厅中间高处，网速提升50%。到店免费帮你调。",
    "换千兆路由器": "5年以上旧路由→换WiFi6千兆。¥200-500，网速翻倍。",
    "升级FTTR光纤": "大户型/复式→FTTR光纤到每间房。月费¥59起，信号满格。"
  },
  "打游戏用什么宽带？延迟对比实测": {
    "100兆 轻度游戏": "延迟50-80ms。适合回合制/策略类，大型FPS会卡。月费¥59。",
    "300兆 主力游戏": "延迟30-50ms。适合90%游戏，MOBA/FPS都稳。月费¥99。推荐。",
    "千兆 电竞级": "延迟10-20ms。职业级体验，直播推流无压力。月费¥169。"
  },
  "老人手机套餐怎么选？3款适老套餐对比": {
    "孝心卡19元": "2G流量+100分钟+防诈骗。¥19/月。适合轻度使用。",
    "孝心卡39元": "10G流量+300分钟+健康服务。¥39/月。推荐。",
    "孝心卡59元": "25G流量+500分钟+视频会员。¥59/月。适合刷抖音老人。"
  },
  "学生套餐怎么选？4款热门横向对比": {
    "校园29元": "20G校园流量。¥29/月。校园内免费，适合低消费。",
    "校园49元": "30G+通话。¥49/月。性价比之选。",
    "校园99元": "100G+1000分钟+宽带。¥99/月。全能型，推荐。"
  },
  "流量不够用？5种加量方案帮你选": {
    "套餐升档": "¥10-20/月，流量翻倍。最划算的方案。",
    "办大流量副卡": "¥10/月，20G独立流量。适合双卡用户。",
    "融合套餐共享": "全家共享100G+，人均¥30-50。全家用最划算。"
  },
  "全屋WiFi怎么布局？90平/120平/复式方案": {
    "90平(单路由)": "一个千兆路由放客厅中间。¥200-400。小户型够用。",
    "120平(Mesh组网)": "2-3节点Mesh组网。¥400-800。全屋无死角。",
    "复式/别墅(FTTR)": "光纤到每个房间。¥59-99/月。一步到位。"
  },
  "家里网络老掉线？先排查这3个原因": {
    "检查位置": "路由器旁有微波炉/冰箱？挪开30cm以上。0成本。",
    "检查散热": "路由器塞柜子里？拿出来通风。0成本。",
    "到店报修": "以上都试了还掉线？到店免费检测线路。"
  },
  "5G套餐到底快多少？实测对比告诉你": {
    "4G套餐 ¥59": "下行50-80Mbps。刷抖音微信够用。月费¥59。",
    "5G入门 ¥79": "下行300-500Mbps。看4K视频流畅。月费¥79。推荐。",
    "5G极速 ¥129": "下行800Mbps+。下载大文件秒完。月费¥129。"
  },
  "老房子没预埋网线怎么办？3种解决方案": {
    "电力猫": "利用电线传输，不布线。适合小户型，¥100-300。",
    "Mesh无线组网": "无线回程，不用打孔。适合90-140平，¥300-800。",
    "FTTR隐形光纤": "透明光纤沿踢脚线走。千兆满速，月¥59起。推荐。"
  },
  "租房宽带怎么选？短期vs长期租房攻略": {
    "短租(<6月)": "短期宽带¥59/月。灵活合约，到期可退。适合短租。",
    "长租(>1年)": "融合套餐¥99/月。宽带+手机卡+路由。划算。",
    "长期+全家用": "全家融合套餐¥169/月。千兆+3张卡。一步到位。"
  },
  "换运营商不换号？携号转网全流程": {
    "查资格": "编辑短信到运营商查能否转。免费，2分钟出结果。",
    "拿授权码": "符合条件去营业厅拿授权码。免费，半小时办好。",
    "来厅选套餐": "带身份证+授权码到电信厅。选套餐当场生效。"
  },
  "宽带到期续费还是换套餐？决策树帮你判断": {
    "原地续费": "原套餐不变继续用。适合对现有套餐满意的老用户。",
    "换新套餐": "同价位流量翻倍。3年以上的套餐建议换新。",
    "升级融合": "全家共享流量+宽带。人均更低。推荐。"
  },
  "多人合租网络怎么分？3种方案优劣对比": {
    "各办各的": "各自办套餐。月费¥59/人起，自由但贵。",
    "合办一条": "合办一条300兆宽带均摊。人均¥33/月。省钱但需一人管理。",
    "融合套餐": "三人融合¥169/月。千兆+3张卡，人均¥56。省心推荐。"
  },
  "家里有学生上网课，宽带怎么选？": {
    "100兆 基础": "1个孩子+轻度上网。月费¥59。适合一孩家庭。",
    "300兆 推荐": "2-3个孩子+家长使用。月费¥99。含网课加速。推荐。",
    "千兆 一步到位": "多孩+智能家居。月费¥169。全场景无瓶颈。"
  },
  "一个人住选什么宽带最划算？100M vs 300M vs 1000M": {
    "100兆 日常用": "刷视频聊天够用。月费¥59。一个人住正解。推荐。",
    "300兆 游戏党": "打网游看4K不卡。月费¥99。适合重度用户。",
    "1000兆 配置过剩": "月费¥169。一个人用太浪费，不推荐。"
  },
  "家庭宽带怎么选？三口之家最优方案": {
    "100兆 轻量": "偶尔上网，不常同时用。月费¥59。紧张。",
    "300兆 推荐": "全家同时在线不卡。月费¥99。含网课加速。推荐。",
    "千兆 旗舰": "4K+游戏+办公互不干扰。月费¥169。一步到位。"
  },
  "监控摄像头需要什么网络？4G还是宽带？": {
    "4G摄像头": "无宽带的地方用。插卡即用，月流量费¥10-20。",
    "WiFi摄像头(宽带)": "已有宽带的地方用。零额外月费，画质稳定。推荐。",
    "两种装齐": "老家+城里都要看。装两台各走各的网。"
  },
  "直播带货用什么网络最稳？选网避坑指南": {
    "100兆 不行": "上行仅20M。推流就满，直播必卡。不推荐。",
    "300兆 个人播": "上行50M。推流+互动+音效不卡。月费¥99。推荐。",
    "千兆 工作室": "上行200M+FTTR。多人同时播。月费¥169。专业级。"
  },
  "智能家居需要多大带宽？最少配置清单": {
    "50个设备以内": "100兆轻松带。智能设备不走主力频段。无需升级。",
    "80个设备以内": "300兆还有余量。智能家居不影响网速。",
    "80+带监控": "可上千兆。全部设备加全屋4K监控。"
  },
  "电视盒子卡顿？可能是宽带的问题": {
    "连WiFi的盒子": "多人抢网卡→升300兆。月费¥99。搞定。",
    "IPTV专线盒子": "机顶盒问题→到厅换新。免费检测。",
    "路由器老旧": "5年以上路由→换WiFi6千兆。¥200起。"
  },
  "电信&联通&移动宽带怎么选？全方位横评": {
    "电信 ¥99": "稳定98.5%，延迟18ms，售后4小时。打游戏首选。推荐。",
    "联通 ¥89": "稳定95%，延迟25ms，售后8小时。日常够用。",
    "移动 ¥79": "稳定91%，延迟35ms，高峰期掉速。图便宜可选。"
  }
};
